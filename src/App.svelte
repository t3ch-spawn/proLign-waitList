...
<main class="relative">
  ...
  >
    ...
    <div class="w-full flex flex-col gap-16 items-center overflow-hidden">
      <button
        class="follow-btn font-franklinGoth bg-black border-black border-[1px] p-3 px-6 rounded-md text-white hover:bg-white hover:text-primOrange hover:border-[1px] hover:border-primOrange"
        >Follow us</button
      >
    ...
    <p class="mx-auto font-cascadiaMono font-semibold">
